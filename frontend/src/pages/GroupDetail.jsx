          ...
          <div>
            {students.map((s, i) => (
              <div key={s.id}
                ...
                role="button"
                tabIndex={0}
                style={{ width:"100%", display:"flex", flexDirection:"column", gap:"6px", padding:"12px 20px", background:"transparent", border:"none", cursor:"pointer", borderBottom: i < students.length - 1 ? `1px solid ${divider}` : "none", fontFamily:"'Inter',sans-serif", transition:"background 0.1s", minWidth:0 }}
